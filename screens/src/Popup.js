...
export default class Popup extends Component {
  ...
  render() {
    ...
    // Pull out movie data
    const { name, company, style, bulbSize, shieldType, stage, imageURI, productURI } = Pacibabyr || {};
        ...
        >
          ...
          <View style={styles.content}>
            ...
            >
              ...
              <View style={[styles.movieInfo, this.getStyles().movieInfo]}>
                ...
                <Text style={styles.genre}>{company}</Text>
              </View>
            </View>
            ...
            <View>
              {/* Day */}
              <Text style={styles.sectionHeader}>Style and Shield Type</Text>
              {/* TODO: Add day options here */}
              <View style={{flexDirection:'row'}}>
                <Text style={styles.infoContainer}>{style}</Text>
                <Text style={styles.infoContainer}>{shieldType}</Text> 
              </View>             
            </View>
            {/* Information */}
            <View>
              ...
              <View style={{flexDirection:'row'}}>
                <Text style={styles.infoContainer}>Stage {stage}</Text>
                <Text style={styles.infoContainer}>Bulb size {bulbSize}</Text> 
              </View> 
            </View>
          ...
          <View style={styles.footer}>
            <TouchableHighlight
              ...
              onPress={() => Linking.openURL(productURI)}
            >
              <Text
                style={styles.button}>
                  Product Website
